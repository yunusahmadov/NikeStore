...
const Hero = ({heroapi:{title,subtitle,btntext,img,sociallinks,videos}}) => {
  ...
  return (
    ...
    <div className='relative h-auto w-auto flex flex-col'>
      ...
      <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container-yunus'>
        <div className='grid items-center justify-items-center mt-28 md:mt-24'>
          ...
          <div className='grid items-center absolute top-[33vh] lg:top-[27vh] lg:gap-3 right-0 gap-6'>
